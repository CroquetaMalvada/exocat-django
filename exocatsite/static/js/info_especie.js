$(document).on( 'click','.mostrar_info_especie', function (e) {
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            //var url_icons_pres_10000_zip = "http://exocatdb.creaf.cat/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=SIPAN:PRESENCIA_SP_10000_global&outputFormat=SHAPE-ZIP&format_options=filename:"+nombre+"_UTM10km.zip&CQL_FILTER=IDSPINVASORA%3D%27"+data['id']+"%27";
            //var url_icons_pres_10000_kml = "http://exocatdb.creaf.cat/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=SIPAN:PRESENCIA_SP_10000_global&outputFormat=application/vnd.google-earth.kml+xml&format_options=filename:"+nombre+"_UTM10km.kml&CQL_FILTER=IDSPINVASORA%3D%27"+data['id']+"%27"
            //var icons_pres_10000="   [ZIP - <a href='/genera_shapefile/?url=" + encodeURIComponent(url_icons_pres_10000_zip) + "' title='Exportar WFS' id='exportar_wfs_presencia_10000'><i class='fa fa-file-zip-o fa-lg'></i></a>]   [KML - <a href='/genera_shapefile/?url=" + encodeURIComponent(url_icons_pres_10000_kml) + "' title='Exportar kml' id='exportar_wms_presencia_10000'><i class='fa fa-globe fa-lg'></i></a>]"
            var icons_pres_10000="   [ZIP - <a href='/genera_shapefile_safe/?id=" + data['id'] + "&name=" + nombre + "&content=pres_10k&format=zip' title='Exportar WFS' id='exportar_wfs_presencia_10000'><i class='fa fa-file-zip-o fa-lg'></i></a>]   [KML - <a href='/genera_shapefile_safe/?id=" + data['id'] + "&name=" + nombre + "&content=pres_10k&format=kml' title='Exportar kml' id='exportar_wms_presencia_10000'><i class='fa fa-globe fa-lg'></i></a>]"
            //var url_icons_pres_1000_zip = "http://exocatdb.creaf.cat/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=SIPAN:PRESENCIA_SP_1000_global&outputFormat=SHAPE-ZIP&format_options=filename:"+nombre+"_UTM1km.zip&CQL_FILTER=IDSPINVASORA%3D%27"+data['id']+"%27";
            //var url_icons_pres_1000_kml = "http://exocatdb.creaf.cat/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=SIPAN:PRESENCIA_SP_1000_global&outputFormat=application/vnd.google-earth.kml+xml&format_options=filename:"+nombre+"_UTM1km.kml&CQL_FILTER=IDSPINVASORA%3D%27"+data['id']+"%27";
            //var icons_pres_1000="   [ZIP - <a href='/genera_shapefile/?url=" + encodeURIComponent(url_icons_pres_1000_zip) + "' title='Exportar WFS' id='exportar_wfs_presencia_10000'><i class='fa fa-file-zip-o fa-lg'></i></a>]   [KML - <a href='/genera_shapefile/?url=" + encodeURIComponent(url_icons_pres_1000_kml) + "' title='Exportar kml' id='exportar_wms_presencia_1000'><i class='fa fa-globe fa-lg'></i></a>]"
            var icons_pres_1000="   [ZIP - <a href='/genera_shapefile_safe/?id=" + data['id'] + "&name=" + nombre + "&content=pres_1k&format=zip' title='Exportar WFS' id='exportar_wfs_presencia_1000'><i class='fa fa-file-zip-o fa-lg'></i></a>]   [KML - <a href='/genera_shapefile_safe/?id=" + data['id'] + "&name=" + nombre + "&content=pres_1k&format=kml' title='Exportar kml' id='exportar_wms_presencia_1000'><i class='fa fa-globe fa-lg'></i></a>]"
            //var icons_pres_citacions_zip = "http://exocatdb.creaf.cat/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=SIPAN:citacions_global&outputFormat=SHAPE-ZIP&format_options=filename:"+nombre+"_citacions.zip&CQL_FILTER=IDSPINVASORA%3D%27"+data['id']+"%27";
            //var icons_pres_citacions_kml = "http://exocatdb.creaf.cat/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=SIPAN:citacions_global&outputFormat=application/vnd.google-earth.kml+xml&format_options=filename:"+nombre+"_citacions.kml&CQL_FILTER=IDSPINVASORA%3D%27"+data['id']+"%27";
            //var icons_pres_citacions="   [ZIP - <a href='/genera_shapefile/?url=" + encodeURIComponent(icons_pres_citacions_zip) + "' title='Exportar WFS' id='exportar_wfs_presencia_10000'><i class='fa fa-file-zip-o fa-lg'></i></a>]   [KML - <a href='/genera_shapefile/?url=" + encodeURIComponent(icons_pres_citacions_kml) + "' title='Exportar kml' id='exportar_wms_citacions'><i class='fa fa-globe fa-lg'></i></a>]"            
            var icons_pres_citacions="   [ZIP - <a href='/genera_shapefile_safe/?id=" + data['id'] + "&name=" + nombre + "&content=cit&format=zip' title='Exportar WFS' id='exportar_wms_citacions'><i class='fa fa-file-zip-o fa-lg'></i></a>]   [KML - <a href='/genera_shapefile_safe/?id=" + data['id'] + "&name=" + nombre + "&content=cit&format=kml' title='Exportar kml' id='exportar_wms_citacions'><i class='fa fa-globe fa-lg'></i></a>]"
            //var icons_pres_masses_zip = "http://exocatdb.creaf.cat/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=SIPAN:presencia_massa_aigua&outputFormat=SHAPE-ZIP&format_options=filename:"+nombre+"_masses_aigua.zip&CQL_FILTER=idtaxon%3D%27"+data['id']+"%27";
            //var icons_pres_masses_kml = "http://exocatdb.creaf.cat/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=SIPAN:presencia_massa_aigua&outputFormat=application/vnd.google-earth.kml+xml&format_options=filename:"+nombre+"_masses_aigua.kml&CQL_FILTER=idtaxon%3D%27"+data['id']+"%27";
            //var icons_pres_masses="   [ZIP - <a href='/genera_shapefile/?url=" + encodeURIComponent(icons_pres_masses_zip) + "' title='Exportar WFS' id='exportar_wfs_presencia_10000'><i class='fa fa-file-zip-o fa-lg'></i></a>]   [KML - <a href='/genera_shapefile/?url=" + encodeURIComponent(icons_pres_masses_kml) + "' title='Exportar kml' id='exportar_wms_masses'><i class='fa fa-globe fa-lg'></i></a>]"
            var icons_pres_masses="   [ZIP - <a href='/genera_shapefile_safe/?id=" + data['id'] + "&name=" + nombre + "&content=ma&format=zip' title='Exportar WFS' id='exportar_wfs_presencia_10000'><i class='fa fa-file-zip-o fa-lg'></i></a>]   [KML - <a href='/genera_shapefile_safe/?id=" + data['id'] + "&name=" + nombre + "&content=ma&format=kml' title='Exportar kml' id='exportar_wms_masses'><i class='fa fa-globe fa-lg'></i></a>]"
...
//            $("#exportar_presencia_10000_transformar").attr("hidden",true);
            ...
            //                    console.log(wkt.write());
                    ...
                    //var icons_pres_10000_transformar_zip = "http://exocatdb.creaf.cat/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=SIPAN:PRESENCIA_SP_10000_global&outputFormat=SHAPE-ZIP&format_options=filename:"+nombre+"_agrupacio_UTM10km.zip&CQL_FILTER="+filtros_url_exportar;
                    //var icons_pres_10000_transformar_kml = "http://exocatdb.creaf.cat/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=SIPAN:PRESENCIA_SP_10000_global&outputFormat=application/vnd.google-earth.kml+xml&format_options=filename:"+nombre+"_agrupacio_UTM10km.kml&CQL_FILTER="+filtros_url_exportar;
                    //var icons_pres_10000_transformar="   [ZIP - <a href='/genera_shapefile/?url=" + encodeURIComponent(icons_pres_10000_transformar_zip) + "' title='Exportar WFS' id='exportar_wfs_presencia_10000'><i class='fa fa-file-zip-o fa-lg'></i></a>]   [KML - <a href='/genera_shapefile/?url=" + encodeURIComponent(icons_pres_10000_transformar_kml) + "' title='Exportar kml' id='exportar_wms_presencia_10000_transformar'><i class='fa fa-globe fa-lg'></i></a>]"
                    var icons_pres_10000_transformar="   [ZIP - <a href='/genera_shapefile_safe/?name=" + nombre + "&cql=" + filtros_url_exportar + "&format=zip&content=trans_10k' title='Exportar WFS' id='exportar_wfs_presencia_10000'><i class='fa fa-file-zip-o fa-lg'></i></a>]   [KML - <a href='/genera_shapefile_safe/?name=" + nombre + "&cql=" + filtros_url_exportar + "&format=kml&content=trans_10k' title='Exportar kml' id='exportar_wms_presencia_10000_transformar'><i class='fa fa-globe fa-lg'></i></a>]"
